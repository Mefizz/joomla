...
<div class="container-popup">
	...
	<form action="../../../../../../index.php" class="form-horizontal" id="imageForm" method="post" enctype="multipart/form-data">
		...
		<iframe id="imageframe" name="imageframe" src="../../../../../../index.php"></iframe>
