...
<div class="row-fluid">
	...
	<div id="j-main-container" class="span10">
		...
		<form action="../../../../../../index.php" name="adminForm" id="mediamanager-form" method="post" enctype="multipart/form-data" >
		...
		<div id="collapseFolder" class="collapse">
			<form action="../../../../../../index.php" name="folderForm" id="folderForm" class="form-inline" method="post">
					<div class="path">
		...
		<form action="../../../../../../index.php" name="folderForm" id="folderForm" method="post">
			<div id="folderview">
				<div class="view">
					<iframe class="thumbnail" src="../../../../../../index.php" id="folderframe" name="folderframe" width="100%" height="500px" marginwidth="0" marginheight="0" scrolling="auto"></iframe>
				</div>
				<?php echo JHtml::_('form.token'); ?>
			</div>
		</form>
